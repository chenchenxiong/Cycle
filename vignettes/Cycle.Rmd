---
title: "Modelling cell type-specific lncRNA regulatory network in autism with Cycle"
...
Cell similarity network with networks in terms of network similarity matrix between 17 cell types
```{r, eval=FALSE, include=TRUE}
...
Cell similarity network with hub lnRNAs in terms of hub similarity matrix between 17 cell types
```{r, eval=FALSE, include=TRUE}
